import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, defineComponent, computed, unref, ref, h, Suspense, nextTick, mergeProps, provide, Fragment, onServerPrefetch, toValue, withAsyncContext, withCtx, createVNode, useSSRContext, onErrorCaptured, resolveDynamicComponent, createApp } from 'vue';
import { h as createHooks, i as getContext, c as createError$1, t as toRouteMatcher, k as createRouter, l as defu, m as hasProtocol, n as joinURL, w as withQuery, s as sanitizeStatusCode, o as isScriptProtocol, p as executeAsync, q as hash } from '../nitro/nitro.mjs';
...
const _routes = [
  ...
  },
  {
    ...
    component: () => import('./plaseaza-comanda.vue.mjs')
  },
  {
    name: "confidentialitate",
    path: "/confidentialitate",
    component: () => import('./confidentialitate.vue.mjs')
  },
  {
    name: "termeni-si-conditii",
    path: "/termeni-si-conditii",
    component: () => import('./termeni-si-conditii.vue.mjs')
  }
];
...
export { useRuntimeConfig as a, useRoute as b, useRouter as c, useNuxtApp as d, nuxtLinkDefaults as e, navigateTo as n, resolveRouteObject as r, server as s, tryUseNuxtApp as t, useProductStore as u };
